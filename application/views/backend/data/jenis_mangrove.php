...
<div class="content-page">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            function load_data() {
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_mangrove/load_data",
                    dataType: "JSON",
            ...
            $(document).on('click', '#btn_add', function() {
                ...
                if (nama == '') {
                    ...
                    Swal.fire({
                        position: "top",
                        type: "warning",
                        title: "Nama jenis_mangrove tidak boleh kosong!",
                        showConfirmButton: !1,
                        timer: 1500
                    })
                    return false;
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_mangrove/tambah",
                    method: 'POST',
            ...
            $(document).on('blur', '.table_data', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_mangrove/update",
                    method: "POST",
                    data: {
                        id: id,
            ...
            $(document).on('click', '.btn_delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "<?= base_url(); ?>backend/jenis_mangrove/delete",
                            method: "POST",
                            beforeSend: function() {
                                swal({
                                    title: "Menunggu",
