...
<div class="content-page">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            function load_data() {
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_tanah/load_data",
                    dataType: "JSON",
            ...
            $(document).on('click', '#btn_add', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_tanah/tambah",
                    method: 'POST',
            ...
            $(document).on('blur', '.table_data', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/jenis_tanah/update",
                    method: "POST",
                    data: {
                        id: id,
            ...
            $(document).on('click', '.btn_delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "<?= base_url(); ?>backend/jenis_tanah/delete",
                            method: "POST",
                            beforeSend: function() {
                                swal({
                                    title: "Menunggu",
