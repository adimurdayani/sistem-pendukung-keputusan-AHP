...
<div class="content-page">
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <p class="sub-header">
                                ...
                                <br>
                                Jika anda ingin mengedit data, anda harus klik <code>kolom pada tabel kemudian isi nama menu</code> dengan catatan nama grup tidak boleh dikosongkan.
                            </p>
                            ...
                            <a href="<?= base_url('backend/user') ?>" class="btn btn-secondary"><i class="fe-arrow-left"></i> Kembali</a>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            function load_data() {
                $.ajax({
                    url: "<?= base_url(); ?>backend/grup/load_data",
                    dataType: "JSON",
                    success: function(data) {
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            html += '<td><button type="button" name="delete_btn" id="' + data[count].id +
                                '" class="btn btn-sm btn-danger btn_delete"><span class="fa fa-trash"></span> Hapus</button>' +
                                ' <button type="button" id="' + data[count].id + '" class="btn btn-sm btn-warning akses"><span class="fa fa-edit"></span> Akses</button>' + '</td></tr>';
                            // console.log('id' + id);
                        }
                        //hasil looping
                        $('tbody').html(html);
            ...
            $(document).on('click', '.akses', function() {
                var id = $(this).attr('id');
                window.location.href = "<?= base_url(); ?>backend/akses_user/get_akses/" + id;
            ...
            $(document).on('click', '#btn_add', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/grup/tambah",
                    method: 'POST',
            ...
            $(document).on('blur', '.table_data', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/grup/update",
                    method: "POST",
                    data: {
                        id: id,
            ...
            $(document).on('click', '.btn_delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "<?= base_url(); ?>backend/grup/delete",
                            method: "POST",
                            beforeSend: function() {
                                swal({
                                    title: "Menunggu",
