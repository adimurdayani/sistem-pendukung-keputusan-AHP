...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <?php if ($get_total_baris_satu_alternatif < 3) : ?>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h4 class="header-title"> <?= $title; ?></h4>
                                <?php echo form_open('backend/alternatif/perbandingan') ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="nilai_alternatif" id="" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="id_alternatif_dua" id="" class="form-control">
                                                <?php foreach ($get_alternatif as $data) : ?>
                                                    <option value="<?= $data->id ?>"><?= $data->nama ?></option>
                                                <?php endforeach; ?>
                                            </select>
                        ...
                        <div class="card-body table-responsive">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?= base_url('backend/alternatif/hapus_all/') ?>" method="POST" id="form-delete">
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <?php foreach ($get_alternatif as $k) : ?>
                                                        <th><?= $k->alternatif_id ?></th>
                                                    <?php endforeach; ?>
                                                </tr>
                                            </thead>

                                            <tbody>
                                                <?php foreach ($get_alternatif as $p) : ?>
                                                    <tr>
                                                        <td style="width: 40px;"><input type="checkbox" class="check-item" name="id[]" value="<?= $p->id_user ?>"></td>
                                                        <td><?= $p->alternatif_id ?></td>

                                                        <?php
                                                        $id_alternatif = $p->id;
                                                        $perbandingan = "SELECT *
                                                                FROM    `perbandingan_dua` JOIN `alternatif`
                                                                ON      `perbandingan_dua`.`id_alternatif` = `alternatif`.`id`
                                                                WHERE   `perbandingan_dua`.`id_alternatif` = $id_alternatif";
                                                        $getperbandingan = $this->db->query($perbandingan)->result();
                                                        ?>

                                                        <?php foreach ($getperbandingan as $n) : ?>
                                                            <td><?= $n->nilai_alternatif ?></td>
                                                        <?php endforeach ?>
                                                    </tr>
                                                <?php endforeach ?>
                                                <tr>
                                                    <th colspan="2" class="text-center">Jumlah</th>
                                                    <?php foreach ($get_alternatif_dua as $j) : ?>
                                                        <?php
                                                        $id_alternatif = $j->id;
                                                        $sql = "SELECT sum(nilai_alternatif) as nilai FROM perbandingan_dua WHERE id_alternatif='$id_alternatif'";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($get_baris_satu_alternatif as $bsa) : ?>
                                                <tr>
                                                    <td>A1</td>
                                                    <td><?= $bsa->nilai ?></td>
                                                    <td><?= $bsa->nilai_dua ?></td>
                                                    ...
                                                    <td><?= $bsa->jumlah ?></td>
                                                    <td>
                                                        <a href="<?= base_url('backend/alternatif/delete_baris_satu_alternatif/') . $bsa->id ?>" class=" btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                        <tr>
                                            ...
                                            <th><?= $sum_baris_satu_alternatif ?></th>
                                            <th></th>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="card-body table-responsive">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php if ($get_total_baris_dua_alternatif < 3) : ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($get_baris_dua_alternatif as $bd) : ?>
                                                <tr>
                                                    <td>A2</td>
                                                    <td><?= $bd->nilai ?></td>
                                                    <td><?= $bd->nilai_dua ?></td>
                                                    ...
                                                    <td><?= $bd->jumlah ?></td>
                                                    <td>
                                                        <a href="<?= base_url('backend/alternatif/delete_baris_dua_alternatif/') . $bd->id ?>" class=" btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        ...
                                        <tr>
                                            ...
                                            <th><?= $sum_baris_dua_alternatif ?></th>
                                            <th></th>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <?php if ($get_total_baris_tiga_alternatif < 3) : ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($get_baris_tiga_alternatif as $bt) : ?>
                                                <tr>
                                                    <td>A3</td>
                                                    <td><?= $bt->nilai ?></td>
                                                    <td><?= $bt->nilai_dua ?></td>
                                                    ...
                                                    <td><?= $bt->jumlah ?></td>
                                                    <td>
                                                        <a href="<?= base_url('backend/alternatif/delete_baris_tiga_alternatif/') . $bt->id ?>" class=" btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                        <tr>
                                            ...
                                            <th><?= $sum_baris_tiga_alternatif ?></th>
                                            <th></th>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <?php if ($get_total_evn_normalisasi_alternatif < 3) : ?>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($get_evn_normalisasi_alternatif as $en) : ?>
                                        <tr>
                                            <td>A<?= $no++ ?></td>
                                            <td><?= $en->nilai ?></td>
                                            <td><?= $en->nilai_dua ?></td>
                                            ...
                                            <td><?= $en->evn ?></td>
                                            <td>
                                                <a href="<?= base_url('backend/alternatif/delete_evn_normalisasi_alternatif/') . $en->id ?>" class=" btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <th><?= $sum_baris_satu_alternatif + $sum_baris_dua_alternatif + $sum_baris_tiga_alternatif ?></th>
                                    <th></th>
                                    <th></th>
                                </tr>
                            </table>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <?php if ($get_total_rasio_konsistensi_alternatif < 1) : ?>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($get_rasio_konsistensi_alternatif as $rk) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <progress value="<?= $persentase ?>" aria-valuemin="0" max="5"></progress>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('backend/alternatif/delete_rasio_konsistensi_alternatif/') . $rk->id ?>" class=" btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
    ...
    <div id="tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("backend/alternatif/tambah_baris_satu_alternatif"); ?>
    ...
    <div id="tambah_baris_dua" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("backend/alternatif/tambah_baris_dua_alternatif"); ?>
                <div class="modal-body p-3">
    ...
    <div id="tambah_baris_tiga" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("backend/alternatif/tambah_baris_tiga_alternatif"); ?>
                <div class="modal-body p-3">
    ...
    <div id="tambah_nilai_evn" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("backend/alternatif/kirim_nilai_alternatif"); ?>
                <div class="modal-body p-3">
    ...
    <div id="tambah_nilai_rasio" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("backend/alternatif/kirim_nilai_rasio_alternatif"); ?>
                <div class="modal-body p-3">

                    <h5>
                        Input jumlah nilai yang ada pada tabel Pairwise Comparison dan tabel EVN
                    </h5>
                    <input type="hidden" name="user_id" value="<?= $session->id ?>">
                    <div class="row">
                        <div class="col-md-6">
