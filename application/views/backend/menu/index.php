...
<div class="content-page">
                ...
                <div class="col-7">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <p class="sub-header">
                                Pada tabel di bawah, anda harus menambahkan menu dengan cara klik <code>kolom pada tabel kosong, kemudian isi nama menu</code> dengan catatan nama menu tidak boleh dikosongkan.
                                <br>
                                Jika anda ingin mengedit data, anda harus klik <code>kolom pada tabel kemudian isi nama menu</code> dengan catatan nama menu tidak boleh dikosongkan.
                            </p>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            function load_data() {
                $.ajax({
                    url: "<?= base_url(); ?>backend/menu/load_data",
                    dataType: "JSON",
                    success: function(data) {
                        //colom inputan
                        var html = '<tr>';
                        html += '<td id="menu" contenteditable placeholder="Nama Menu"></td>';
                        ...
                        for (var count = 0; count < data.length; count++) {
                            ...
                            html += '<td class="table_data" data-row_id="' + data[count].id +
                                '" data-column_name="menu" contenteditable>' + data[count].menu +
                                '</td>';
            ...
            $(document).on('click', '#btn_add', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/menu/tambah",
                    method: 'POST',
            ...
            $(document).on('blur', '.table_data', function() {
                ...
                $.ajax({
                    url: "<?= base_url(); ?>backend/menu/update",
                    method: "POST",
                    data: {
                        id: id,
            ...
            $(document).on('click', '.btn_delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "<?= base_url(); ?>backend/menu/delete",
                            method: "POST",
                            beforeSend: function() {
                                swal({
                                    title: "Menunggu",
